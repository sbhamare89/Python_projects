...
class NseIndia:
    ...
    def live_market_data(self):
        ...
        df = df.drop(["priority","meta","identifier","ffmc","yearHigh","yearLow","totalTradedVolume","totalTradedValue","nearWKH","nearWKL","perChange365d","date365dAgo","chart365dPath","date30dAgo","perChange30d","chart30dPath","chartTodayPath","series"], axis=1)
        # return list(df["symbol"])
        return df
